...
<div class="flex flex-1 overflow-hidden">
	...
	<div class="flex flex-col flex-1 overflow-hidden">
		...
		<div class="flex flex-col flex-1 overflow-hidden">
			...
			<div class="flex flex-col flex-1 overflow-hidden min-h-0 transition-opacity {selectedSubagent ? 'opacity-80' : ''}">
			...
			{#if selectedSubagent}
				...
				<div class="flex flex-col flex-1 overflow-hidden min-h-0 shadow-[0_-4px_20px_rgba(45,212,191,0.15),0_0_40px_rgba(45,212,191,0.08)]">
